...
INSERT INTO `room` (`Room_Key`, `IDRoom`, `Details`, `RT_ID`) VALUES
(1, 'LS101', '', 1),
(2, 'LS102', '', 1),
(3, 'LS103', '', 1),
(4, 'LS104', '', 1),
...
INSERT INTO `roomtype` (`RT_ID`, `RoomType`, `Description`, `PriceRoom`, `SizeRoom`) VALUES
...
(2, 'Deluxe Suite', 'The most arresting feature of the Duplex Suite is the two-story suite, a wooden staircase which leads to the upper level and formal living room plus outside private furnished balcony. The suite	is beautifully decorated with a mix of Thai traditional materials and contemporary design', 9600, '58 Sq.m.'),
(3, 'Double Room', 'Standard rooms are appointed with Twin Beds. The elegant room is perfectly decorate in rich Thai traditional fabrics and local wood, included all the amenities of guest room.', 5800, '38 Sq.'),
(4, 'Single Room', 'Standard rooms are appointed with King Size bed. The elegant room is perfectly decorate in rich Thai traditional fabrics and local wood, included all the amenities of guest room.', 5200, '38 Sq.');
